...
train_pipeline = [
  ...
  #  dict(type='Resize', img_scale=[(2600, 1080), (2600, 720)], keep_ratio=True),
    dict(type='Resize', img_scale=[(1480, 640), (1080, 480)], keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'DarkFace_Train_COCO_Path.json',
...
log_level   = 'INFO'
load_from   = None
resume_from = 'work_dirs/cascade_rcnn_rx101_fpn_dconv_c3-c5_darface_boxshift/epoch_10.pth'
workflow    = [('train', 1)]
