...
data_root = '/data/Dataset/DarkFace/DarkFace_Train_Light/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'DarkFace_WideFace_Train.json',
        img_prefix=data_root,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'DarkFace_Val.json',
        img_prefix=data_root,
...
log_level   = 'INFO'
load_from   = None#'work_dirs/cascade_rcnn_r50_fpn_dconv_c3-c5_darface_2/epoch_160.pth'
resume_from = None
workflow    = [('train', 1)]
