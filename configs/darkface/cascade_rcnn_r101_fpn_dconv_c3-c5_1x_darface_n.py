...
log_level   = 'INFO'
load_from   = None#'weights/cascade_rcnn_r101_fpn_dconv_c3-c5_1x_coco_20200203-3b2f0594.pth'
resume_from = None
workflow    = [('train', 1)]

##  CUDA_VISIBLE_DEVICES=0,1,2,3 PORT=29502 bash tools/dist_train.sh configs/darkface/cascade_rcnn_r101_fpn_dconv_c3-c5_1x_darface_n.py 4
